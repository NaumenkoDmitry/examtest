...
export const getOffers = ({ limit, offset }) => httpClient.get(`/offers?limit=${limit}&offset=${offset}`);
export const setOfferModerationStatus = ({offerId, ...data}) => httpClient.patch(`/offers/${offerId}`, data);
